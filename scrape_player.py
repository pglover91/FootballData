...
class Scraper(object):
            ...
            for n, table in enumerate(tables):
                ...
                for p in player:
                    ...
                    if player:
                        ...
                        # print(f'Yellow card: {num_yellow_card}')
                        # print(f'Red card: {num_red_card}')

                        columns = ['team', 'player', 'yc', 'rc', 'ground']
                        data = [team, player, num_yellow_card, num_red_card, ground]
    ...
    def format_card_data_per_team(self, df):
        ...
        total_df.sort_values('total_yc', ascending=False).to_csv('/home/paul/{}.csv'.format(self.league))
